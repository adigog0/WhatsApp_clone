...
interface Iprops{
    sendMessageHandler:(e: React.KeyboardEvent<HTMLInputElement>) => void
}
const UserInput = ({sendMessageHandler}:Iprops) => {
    return (
        <div className="w-full flex items-center justify-center rounded-lg p-2">
            <div className="h-16 flex justify-between items-center px-8 py-2 w-9/12 bg-slate-200 rounded-xl  ml-4">
                ...
                <input type="text" className="w-5/6 p-3 rounded-lg " placeholder="type a message" onKeyDown={(e)=>sendMessageHandler(e)}/>
